...
import useRevisiAdminModal from "./useRevisiAdminModal";
...
const RevisiAdminModal = (props: PropTypes) => {
  const {
    isOpen,
    onOpenChange,
  ...
  const {
    ...
    fileToUpload,
    setFileToUpload,
  } = useRevisiAdminModal(selectedPenilaianId);
...
export default RevisiAdminModal;
